 ...
 */
export declare function Popover({ title, content, placement, closeDelay, visible, onVisibilityChange, triggerEvent, children, portalParent, }: PopoverProps): JSX.Element;
export {};
