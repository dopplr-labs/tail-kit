 ...
 */
export declare function Pagination({ current, defaultCurrent, total, pageRangeDisplayed, boundaryPageButtons, showSizeChanger, showQuickJumper, pageSizeOptions, onChange, className, style, }: PaginationProps): JSX.Element;
