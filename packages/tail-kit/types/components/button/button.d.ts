 ...
 * Button properties
 */
export declare type ButtonProps = Omit<React.DetailedHTMLProps<React.ButtonHTMLAttributes<HTMLButtonElement>, HTMLButtonElement>, 'children'> & {
 ...
 */
export declare const Button: React.ForwardRefExoticComponent<Pick<Omit<React.DetailedHTMLProps<React.ButtonHTMLAttributes<HTMLButtonElement>, HTMLButtonElement>, "children"> & {
    /** text rendered inside button */
    children?: string;
    /** icon rendered */
    icon?: JSX.Element;
