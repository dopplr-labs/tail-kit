...
export declare function DatePicker({ date, defaultDate, onChange, placeholder, allowClear, startDate, endDate, disableDate, className, style, }: DatePickerProps): JSX.Element;
export {};
