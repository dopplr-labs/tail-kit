 ...
 */
export declare function isDateEqual(dateA: Date | undefined, dateB: Date | undefined, comparatorFunction?: (date: Date) => number): boolean;
/**
...
export declare function isDateDisabled(date: Date, startDate?: Date, endDate?: Date, disableDate?: (date: Date) => boolean): boolean;
