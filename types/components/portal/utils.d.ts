 ...
 */
export declare function getContentVerticalPlacement(triggerBCR: DOMRect, contentContainerBCR: DOMRect, offsetVertical?: number): VerticalPlacement;
/**
 ...
 */
export declare function getContentHorizontalPlacement(triggerBCR: DOMRect, contentContainerBCR: DOMRect): HorizontalPlacement;
/**
 ...
 */
export declare function getContentPosition(triggerBCR: DOMRect, contentContainerBCR: DOMRect, placement: [VerticalPlacement, HorizontalPlacement], offsetVertical?: number): {
    top: number;
    left: number;
};
/**
