...
export declare const Checkbox: React.ForwardRefExoticComponent<Pick<Omit<React.DetailedHTMLProps<React.InputHTMLAttributes<HTMLInputElement>, HTMLInputElement>, "disabled" | "style" | "className" | "onChange" | "checked"> & {
    /** HTML checked attribute for input element to set input status true or false */
    checked?: boolean | 'indeterminate';
    /** Default checked property to intialize component */
    defaultChecked?: boolean | 'indeterminate';
