...
export declare function Modal({ title, children, onOK, onCancel, okButtonProps, cancelButtonProps, visible, onRequestClose, actions, portalParent, }: ModalProps): React.ReactPortal;
export {};
