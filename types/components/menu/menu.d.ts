 ...
 */
export declare function Menu({ trigger, children, portalParent, verticalPlacement, horizontalPlacement, }: MenuProps): JSX.Element;
...
export declare function MenuItem({ label, icon, onClick, className, style, }: MenuItemProps): JSX.Element;
...
export declare function MenuDivider({ className, style }: MenuDividerProps): JSX.Element;
