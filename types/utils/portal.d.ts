 ...
 */
export declare function getPlacement({
  triggerBCR,
  contentContainerBCR,
  defaultPlacement,
  allowedPlacements,
...
export declare function isVerticalPlacementValid({
  triggerBCR,
  contentContainerBCR,
  verticalPlacement,
  offsetVertical,
...
export declare function isHorizontalPlacementValid({
  triggerBCR,
  contentContainerBCR,
  horizontalPlacement,
  offsetHorizontal,
...
export declare function getTopPosition({
  triggerBCR,
  contentContainerBCR,
  verticalPlacement,
  offsetVertical,
...
export declare function getLeftPosition({
  triggerBCR,
  contentContainerBCR,
  horizontalPlacement,
  offsetHorizontal,
