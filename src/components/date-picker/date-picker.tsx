...
export function DatePicker({
  ...
  useOutsideClick({
    containers: useMemoOne(() => [triggerContainer, calendarContainer], []),
  ...
  return (
    <div style={style} className={className}>
      <div
        className="flex items-center px-3 py-2 space-x-3 text-gray-400 border rounded-md"
      ...
      <Portal triggerRef={triggerContainer} visible={calendarVisible}>
        <div className="bg-white rounded shadow w-80" ref={calendarContainer}>
                      ...
                      >
                        {weekDays.map((day) => (
                          <button
                            ...
                            onClick={() => {
                              setActiveDate(
                                dayjs(day).startOf('month').toDate(),
                              )
                              setCalendarVisible(false)
                              if (onChange) {
                                onChange(day)
