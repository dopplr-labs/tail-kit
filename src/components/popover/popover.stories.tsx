      ...
      content={
        <div className="w-64">
          ...
          <div className="text-sm text-gray-500">
            <span className="mr-1 font-semibold text-gray-700 tabular-nums">
...
export function PopoverWithClickTrigger() {
  const user = {
    name: {
      first: 'Brad',
      last: 'Gibson',
...
export function ControlClosingOfPopover() {
  ...
  return (
    <Popover
      content={
        <div className="w-64 space-y-3">
          <div className="text-sm">
            Click on the close button below to the popover
          </div>
          <Button
            label="Close Me"
            onClick={() => {
      ...
      trigger={Popover.Trigger.click}
      title="Control Closing of Popover"
    >
      <Button
        label="Click Me"
